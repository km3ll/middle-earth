...
import frdm.generators.{ GenAccountNo, GenCheckingAccount, GenSavingAccount }
...
class AccountRepositoryH2Test extends AnyFlatSpec with BeforeAndAfterAll with Matchers {
  ...
  "H2 Account repository" should "return a previously persisted Checking account" in {
  ...
  it should "return a previously persisted Saving account" in {
  ...
  it should "report a non-existent account" in {
  ...
  it should "report a record with invalid account type" in {
  ...
  it should "report a record with invalid dateOfOpen" in {
  ...
  it should "report a record with invalid dateOfClose" in {
  ...
  it should "read a valid DB record" in {

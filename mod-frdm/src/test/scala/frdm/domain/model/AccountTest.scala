...
class AccountTest extends AnyFlatSpec with Matchers {
  ...
  "Checking Account constructor" should "create an account" in {
  ...
  it should "assign a date-of-open when not provided" in {
  ...
  it should "report a list of errors when provided invalid data" in {
  ...
  "Saving Account constructor" should "create an account" in {

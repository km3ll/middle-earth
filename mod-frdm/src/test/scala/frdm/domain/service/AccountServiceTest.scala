package frdm.domain.service

import java.util.Calendar
import frdm.generators.{ GenAccount, GenCheckingAccount, GenSavingAccount }
import frdm.domain.model.{ CheckingAccount, SavingAccount }
import frdm.infrastructure.persistence.AccountRepositoryMock
...
class AccountServiceTest extends AsyncFlatSpec with ScalaFutures with Matchers {
  ...
  "openCheckingAccount" should "create and persist a new account" in {
  ...
  it should "reject an account if it is already persisted" in {
  ...
  it should "reject an account with invalid data" in {
  ...
  "openSavingAccount" should "create and persist a new account" in {
  ...
  "findAccountByNumber" should "return an existing account" in {
  ...
  it should "report a non existing account" in {
  ...
  "upsertAccount" should "persist an account" in {
  ...
  "validateNewAccount" should "report a non existing account as success" in {
  ...
  it should "report an existing account as error" in {
